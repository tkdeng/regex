...
//! Deprecated: Replaced with 1.27 generic methods (use RepFunc instead)
...
//! Deprecated: Replaced with 1.27 generic methods (use RepFuncBreak instead)
...
//! Deprecated: Replaced with 1.27 generic methods (use Rep instead)
...
//! Deprecated: Replaced with 1.27 generic methods (use RepLit instead)
